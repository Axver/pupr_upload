					...
					<div class="col-xl-12 col-lg-12">
						<div class="card shadow mb-12">
							...
							<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
								<h6 class="m-0 font-weight-bold text-primary">Laporan Pengawasan</h6>
									...
									while($i<$length)
									{
										...
										<tr>
                                         <td ><?php echo $i+1; ?></td>
											...
											<td><button class="btn btn-info" onclick="viewLap('<?php echo $query[$i]->id_lap_pengawasan; ?>')">Lihat</button></td>
										</tr>
									<?php
