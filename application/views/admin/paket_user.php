...
<div id="wrapper">
	...
	<?php $this->load->view('modal/paket_untuk_user'); ?>
	<!-- End of Sidebar -->
					...
					<div class="col-xl-12 col-lg-12">
						<div class="card shadow mb-12">
							...
							<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
								<h6 class="m-0 font-weight-bold text-primary">Paket Untuk User</h6>
...
<script>
	...
	function paketUser(nip)
	{
	    $("#modal_nip").val(nip);
	    $("#paketUser").modal("show");

	}

	function paketUserLihat(nip)
	{
	    alert(nip);
	}
</script>
